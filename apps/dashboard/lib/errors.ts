...
export const ApiErrorCode = {
  ...
  DeliveryNotReplayable: 'DELIVERY_NOT_REPLAYABLE',
...
const HUMANIZED: Record<ApiErrorCode, string> = {
  ...
  CHANNEL_IN_USE: 'This notification channel is still used by an escalation policy.',
  NOTIFICATION_DELIVERY_FAILED: 'The test notification could not be delivered.',
  DELIVERY_NOT_FOUND: 'That delivery does not exist.',
  DELIVERY_NOT_REPLAYABLE: 'Only terminal-failed deliveries can be replayed.',
