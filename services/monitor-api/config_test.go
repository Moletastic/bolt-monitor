...
func TestNewProductionMonitorHandlerAssemblesDependenciesWithoutAWS(t *testing.T) {
	...
	if handler.operations.services.audit.store == nil || handler.operations.services.create.store == nil || handler.principalResolver == nil || handler.membershipResolver == nil || handler.senders == nil || handler.executor == nil || handler.validateDestination == nil {
