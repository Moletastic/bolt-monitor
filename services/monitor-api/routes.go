...
var monitorRoutes = []routeDefinition{
	...
	{"GET", "/api/v1/incidents", "listIncidents"}, {"GET", "/api/v1/incidents/{incidentId}", "getIncident"}, {"GET", "/api/v1/incidents/{incidentId}/escalation-state", "getEscalationState"}, {"GET", "/api/v1/incidents/{incidentId}/activities", "getIncidentActivities"}, {"POST", "/api/v1/incidents/{incidentId}/ack", "acknowledgeIncident"}, {"POST", "/api/v1/incidents/{incidentId}/resolve", "resolveIncident"},
