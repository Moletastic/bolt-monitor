...
- [x] 1.3 Add unit tests for record reservation, expiry, payload mismatch, and concurrent equivalent requests.
...
- [x] 3.2 Add handler tests for lowercase headers, retries, partial failure, and no duplicate side effects.
