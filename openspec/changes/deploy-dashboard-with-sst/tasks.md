...
- [x] 1.2 Inject `MONITOR_API_BASE_URL` into the dashboard site from the deployed API URL
- [x] 1.3 Add `dashboardUrl` to SST stack outputs

## 2. Validation

- [x] 2.1 Run `cd infra && npm run check` to validate the SST stack shape
...
- [x] 3.2 Update `apps/dashboard/README.md` to note SST deployment path and stack-managed `MONITOR_API_BASE_URL`
