...
Define how the dashboard renders while server data is loading so the operator sees stable placeholders that match the destination page rather than empty layout shifts.
