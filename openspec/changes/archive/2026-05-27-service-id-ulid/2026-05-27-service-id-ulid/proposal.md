...
- **service-id-auto-generation**: Service ID is server-generated ULID. Client no longer provides `serviceId` on create. Response includes generated `serviceId`.
- **monitor-id-auto-generation**: Monitor ID is server-generated slug derived from monitor type + target URL or name. Client no longer provides `monitorId` on create. Response includes generated `monitorId`.
