...
Define local Git hook behavior for repository contributors. Local hooks reduce
formatting drift before CI by running focused checks at commit time while keeping
repository CI authoritative for pull requests and main branch updates.
