...
- **WHEN** operator calls `GET /api/v1/services/{serviceId}/audit` for an existing service
...
- **WHEN** operator calls `GET /api/v1/services/{serviceId}/audit` for a non-existent service
