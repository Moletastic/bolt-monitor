# notification-channel-test-send Specification

## Purpose
Define how operators send real test notifications through registered notification channels and receive safe, actionable feedback.
