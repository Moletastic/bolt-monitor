...
Define how canonical `CheckRun` records and monitor-status projections absorb retry, redelivery, and out-of-order recurring results without regressing state.
## Requirements
